...
| v0.5 | 타임아웃·응답 불일치 통합 근거 부족 | 병원 API 1회 재시도 정책을 구현하고, 오류 주입·응답 검증을 DB·Mock 통합 시험으로 분리 | T-04 통제 Mock 오류 주입에서 1회 재시도·안전 종료·Trace 기록 PASS. T-05는 저장 결과 기반 응답 형성 단위 검증을 완료했으며, 강제 불일치 주입 후 자동 재구성 시험은 확대 항목으로 관리 |
