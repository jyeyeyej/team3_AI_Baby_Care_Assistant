...
def render() -> None:
    ...
    feeding_interval_label = (
        f"{feeding_interval_minutes // 60}시간 {feeding_interval_minutes % 60}분"
        if feeding_interval_minutes % 60
        else f"{feeding_interval_minutes // 60}시간"
    )
    ...
    with records_column:
        st.markdown(
            f'''<div class="home-card"><div class="home-title">최근 7일 육아 기록</div><div class="home-stats"><div class="home-stat"><div class="home-label">수유</div><div class="home-value">7 <span class="home-unit">하루 평균</span></div></div><div class="home-stat"><div class="home-label">수면</div><div class="home-value">15시간 <span class="home-unit">하루 평균</span></div></div><div class="home-stat"><div class="home-label">배변</div><div class="home-value">5 <span class="home-unit">하루 평균</span></div></div></div></div><div class="home-card"><div class="home-title">몸무게 성장</div><div class="home-label">같은 성별·월령 기준과 비교한 참고 그래프</div><svg class="growth-chart" viewBox="0 0 430 180"><path d="M42 32H410 M42 72H410 M42 112H410 M42 145H410" stroke="#E3E7F1" stroke-dasharray="3 3"/><path d="M52 119 L140 103 L228 86 L316 67 L402 {growth_y}" fill="none" stroke="#6374DC" stroke-width="3"/><g fill="#6374DC"><circle cx="52" cy="119" r="4"/><circle cx="140" cy="103" r="4"/><circle cx="228" cy="86" r="4"/><circle cx="316" cy="67" r="4"/><circle cx="402" cy="{growth_y}" r="4"/></g><g fill="#778198" font-size="11"><text x="4" y="36">5kg</text><text x="4" y="76">4kg</text><text x="4" y="116">3kg</text><text x="40" y="169">출생</text><text x="126" y="169">1주</text><text x="214" y="169">2주</text><text x="302" y="169">3주</text><text x="385" y="169">현재</text></g><text x="370" y="{growth_label_y}" fill="#6374DC" font-size="11" font-weight="700">{current_weight:.1f}kg</text></svg></div><div class="home-card"><div class="home-title">최근 7일 수유 간격</div><div class="home-label">알림 간격 {feeding_interval_label} 기준</div><svg class="feeding-chart" viewBox="0 0 430 155"><path d="M38 24H418 M38 58H418 M38 92H418 M38 126H418" stroke="#E3E7F1" stroke-dasharray="3 3"/><path d="M38 92H418" stroke="#F2A365" stroke-width="2" stroke-dasharray="5 4"/><path d="M48 110 L108 92 L168 100 L228 68 L288 80 L348 52 L408 61" fill="none" stroke="#6374DC" stroke-width="3"/><g fill="#6374DC"><circle cx="48" cy="110" r="3.5"/><circle cx="108" cy="92" r="3.5"/><circle cx="168" cy="100" r="3.5"/><circle cx="228" cy="68" r="3.5"/><circle cx="288" cy="80" r="3.5"/><circle cx="348" cy="52" r="3.5"/><circle cx="408" cy="61" r="3.5"/></g><g fill="#778198" font-size="10"><text x="3" y="28">5시간</text><text x="3" y="62">4시간</text><text x="3" y="96">3시간</text><text x="3" y="130">2시간</text><text x="42" y="149">월</text><text x="102" y="149">화</text><text x="162" y="149">수</text><text x="222" y="149">목</text><text x="282" y="149">금</text><text x="342" y="149">토</text><text x="402" y="149">일</text></g></svg><div class="feeding-legend"><span><b style="color:#6374DC">●</b> 서아의 기록</span><span><b style="color:#F2A365">●</b> 설정 알림 간격</span></div></div>''',
            unsafe_allow_html=True,
        )
